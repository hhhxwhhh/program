...
void main()
{
    ...
    vec3 timeColor = vertexColor;
    timeColor.r += sin(time * 2.0) * 0.3;
    timeColor.g += cos(time * 1.5) * 0.3;
    timeColor.b += sin(time * 3.0) * 0.3;
    
    FragColor = vec4(clamp(timeColor, 0.0, 1.0), 1.0);
}
)";
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Rotating Rainbow Cube", nullptr, nullptr);
    if (window == nullptr) {
